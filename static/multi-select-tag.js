function MultiSelectTag(e, t = { shadow: !1, rounded: !0 }) {
  var l = null,
    ...
    p = null,
    h = t.tagColor || {};
  (h.textColor = h.textColor || "black"),
    (h.borderColor = h.borderColor || "#e6e6b7"),
    (h.bgColor = h.bgColor || "rgb(235, 226, 190)");
  var m = new DOMParser();
  function g(e, t, l = !1) {
  ...
  function C(e) {
    ...
    t.classList.add("item-container"),
      (t.style.color = "black"),
      (t.style.borderColor = "#e6e6b7"),
      (t.style.background = "rgb(235, 226, 190)");
